...
const BitacoraView = ({ currentUser, initialProjectId = null }) => {
    ...
    useEffect(() => {
        const fetchDatosGlobales = async () => {
            try {
                ...
                const proyectosData = projsRes.data || [];
                const viviendasGlobal = vivsRes.data || [];
                const evidenciasGlobal = evidsRes.data || [];
    ...
    useEffect(() => {
        ...
        const fetchViviendas = async () => {
            console.log('🔍 FETCH: Iniciando carga de viviendas para proyecto:', selectedProyecto.id);
            ...
            if (error) {
                ...
                console.log(`✅ FETCH SUCCESS: Se cargaron ${data?.length || 0} viviendas:`, data);
            }
            setViviendasDB(data || []);
        };
        fetchViviendas();
